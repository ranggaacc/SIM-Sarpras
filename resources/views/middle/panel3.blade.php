            ...
            <div class="row">
              <div class="col-lg-12">
                <h1 class="page-header">
                    <br><br>
                      <b>Sarpras Kondisi Rusak Ringan </b><br><b><h4> SIM-SARPRAS</h4></b>
                </h1>
              </div>
            </div>
            @php
            $RR=0;
                for ($i=0 ; $i<$inventarispanel3->count() ; $i++) {
                    
                    $RR+=$inventarispanel3[$i]->RR;
                }
            @endphp                      
            <div class="row">
                <div class="col-md-6">
                    <div class="thumbnail"> 
                      <div class="caption">
                        <p style="font-family:roboto; color:grey;">Total Sarpras&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:{{ $inventarispanel3->count() }} Jenis</p>
                        <p style="font-family:roboto; color:grey;">Jumlah Baru&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Dengan {{ $RR }} buah kondisi rusak ringan</p>
                      </div>
                    </div>
                        ...
                        <table class="table table-condensed table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th><center>Jumlah Rusak Ringan</center></th>
