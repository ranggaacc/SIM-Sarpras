      ...
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">
            ...
            <h4>            
              <b>Sarana & Prasarana Semua Unit</b><br><b></b>
            </h4>
            </b>
          </h1>
        </div>
        ...
        <div class="btn-toolbar">
          <a class="btn btn-xl btn-group btn-primary pull-let" href="/sarprasall/excelAll"><i class="fa fa-file-excel-o"></i> Export All Data</a>
          <a href="" class="btn btn-xl btn-default pull-let" role="button" data-toggle="modal" data-target="#ModalPrint2" data-toggle="tooltip" title="Unduh data sesuai inputan Kode, Tahun, Nama, Merk ,dan Lokasi"><i class="fa fa-file-excel-o" ></i> Export Option</a>                        
        </div>
          <br>
          <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="/sarprasall/search" method="get" id="form1">
                          <p>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">  
                          <div class="panel panel-lg-default">
                            <center>
                              <div id="keren">
                                  <h4 style="font-family:roboto; color:black;">DETAIL INVENTARIS {{ $inventaris->unit }}</h4>
                              </div>
                              <br>
                            </center>  
