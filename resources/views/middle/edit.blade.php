        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                      ...
                      <br>
                        @if($unit->nama=='UIH')
                        <b>Edit Sarana & Prasarana</b><br><b><h4> {{ $unit->nama }} (Unit Informasi & Humas)</h4></b>
                        @elseif($unit->nama=='UKBB')
                        <b>Edit Sarana & Prasarana</b><br><b><h4> {{ $unit->nama }} (Unit Konservasi Budidaya Biofarmaka)</h4></b>
                        @elseif($unit->nama=='UKHP')
                        <b>Edit Sarana & Prasarana</b><br><b><h4> {{ $unit->nama }} (Unit Kandang Hewan Percobaan)</h4></b>
                        @elseif($unit->nama=='UPPW')
                        <b>Edit Sarana & Prasarana</b><br><b><h4> {{ $unit->nama }} (Unit Pilot Plant & Workshop)</h4></b>
                        @elseif($unit->nama=='LPSB')
                        <b>Edit Sarana & Prasarana</b><br><b><h4> {{ $unit->nama }} (Laboratorium PSB)</h4></b>
                        @endif
                    </h1>
            ...
            <div class="row" id="jumlah">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    {!! Form::model($inventaris, ['route' => ['inventaris.update', $inventaris->id], 'method'=>'patch', 'files' => true]) !!}
                      ...
                      <div class="col-md-6">
                        ...
                        <!-- Modal Footer -->
                            <div class="modal-footer">
                                ...
                                <a class="btn btn-link pull-left" href="{{ route('inventaris.index') }}"><i class="glyphicon glyphicon-backward"></i>  Kembali</a>
                            </div>
