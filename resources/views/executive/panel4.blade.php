            ...
            <div class="row">
              <div class="col-lg-12">
                <h1 class="page-header">
                    <br><br>
                      <b>Sarpras Kondisi Rusak Berat </b><br><b><h4> SIM-SARPRAS</h4></b>
                </h1>
              </div>
            </div>                       
            @php
            $RB=0;
                for ($i=0 ; $i<$inventarispanel4->count() ; $i++) {
                    $RB+=$inventarispanel4[$i]->RB;
                }
            @endphp                      
            <div class="row">
                <div class="col-md-6">
                    <div class="thumbnail"> 
                      <div class="caption">
                        <p style="font-family:roboto; color:grey;">Total Sarpras&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:{{ $inventarispanel4->count() }} Jenis</p>
                        <p style="font-family:roboto; color:grey;">Jumlah Baru&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: Dengan {{ $RB }} buah kondisi rusak berat</p>
                      </div>
                    </div>
                        ...
                        <table class="table table-condensed table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th><center>Jumlah Rusak Berat</center></th>
