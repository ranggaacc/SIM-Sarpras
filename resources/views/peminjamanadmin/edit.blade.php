            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    {!! Form::model($peminjaman, ['route' => ['peminjaman.update', $peminjaman], 'method'=>'patch', 'files' => true]) !!}
                          ...
                          <input type="date" id="tanggal_pengajuan-field" name="tanggal_pengajuan" class="form-control" value="{{ $peminjaman->tanggal_pengajuan }}"/>
                          ...
                          <div class="form-group @if($errors->has('keterangan')) has-error @endif">
                             ...
                             <textarea id="keterangan" class="form-control" name="keterangan" value="{{ $peminjaman->keterangan }}">{{ $peminjaman->keterangan }}</textarea>
